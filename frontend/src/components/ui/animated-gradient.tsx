...
const presets: Record<string, any> = {
  ...
  Ghost: {
    // Customised with subtle greenish/teal brand tones for the Saathi AI ghost navbar
    color1: "rgba(0, 64, 56, 0.22)", // Saathi Teal with transparency
    color2: "rgba(0, 84, 76, 0.15)", // Deep Moss with transparency
    color3: "rgba(232, 245, 240, 0.55)", // Soft green/cream wash with transparency
    rotation: 45,
    proportion: 55,
    scale: 0.35,
    speed: 6, // Slower, more calming movement
    distortion: 12,
    swirl: 25,
    swirlIterations: 5,
    softness: 100,
