    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div style={{ 
          padding: '24px 20px', 
          textAlign: 'center', 
          background: 'rgba(0, 64, 56, 0.04)', 
          borderRadius: '16px', 
          border: '1.5px dashed rgba(0, 64, 56, 0.15)',
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          gap: '12px'
          ...
          <div>
            <h3 style={{ margin: '0 0 4px 0', fontSize: '16px', fontWeight: 600, color: '#0f161e' }}>
              No login required
            </h3>
            <p style={{ margin: 0, fontSize: '14px', color: '#615f5c', lineHeight: 1.5 }}>
              Job seekers don't need a web account. Simply message our SaathiAI bot on WhatsApp to find jobs, track your applications, and get support.
            </p>
          </div>
          <a
            href="https://wa.me/917030878277" 
            target="_blank"
